...
class UsesGenerator extends BaseGenerator
{
    ...
    private function _generate($fields, $model)
    {
        ...
        $this->serviceFile->createFile($path, 'index.ts', $templateData);
        // create table.tsx
        ...
        $this->serviceFile->createFile($path, 'table.tsx', $templateData);
        // create form.tsx
        ...
        $this->serviceFile->createFile($path, 'form.tsx', $templateData);
        // import uses/index.ts
        $fileNameReal = 'index.ts';
